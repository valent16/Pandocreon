...
public class Divinity extends Card{
	...
	public Divinity(String nom, Origin origine, String capaciteSpeciale, Dogme dogme1, Dogme dogme2, Dogme dogme3 ) {
		super(nom, origine, dogme1, dogme2, dogme3);
		this.capaciteSpeciale = capaciteSpeciale;
	}

	/**Ajout des divinites dans la parties
	 * @param nom de la divinité
	 * @param origin origine de la divinité
	 * @param capacitéSpeciale description de la capacité de la divinité
	 * @return retourne un ArrayList contenant toutes les divinités
	 */

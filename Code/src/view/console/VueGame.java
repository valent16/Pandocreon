...
public class VueGame {
	...
	public void creationJoueurs(int nbJoueur){
		...
		for(int i = 0; i<nbJoueur; i++){
			...
			do{
				if (!choix.equals("3")){
					System.out.println("Vous avez fait un erreur lors de l'entr�e de la valeur");
				}
	...
	public void creationHumain(){
		...
		while(!age.matches("[0-9]+")){
			System.out.println("l'age entr� est invalide");
			age = sc.nextLine();
		}
	...
	public void creationBot(int index){
		...
		System.out.println("Veuillez renseigner le niveau de difficult� de ce bot : ");
		System.out.println("1- facile");
		System.out.println("2- medium");
		System.out.println("3- difficile");
		String choix = sc.nextLine();
		while(!choix.matches("[0-9]+") && Integer.parseInt(choix)>3 && Integer.parseInt(choix)<1){
			System.out.println("le choix de difficult� est invalide");
		}

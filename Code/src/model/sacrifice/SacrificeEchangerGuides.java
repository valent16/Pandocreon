...
/**Echange un de vos guides spirituels avec un d'une autre divinite a condition que la divinite possede le dogme NUIT, Mystique, Chaos. 
 * Vous choisissez les deux guides spirituels en question. 
 * Les croyants restent attaches aux memes cartes
 */
public class SacrificeEchangerGuides extends Sacrifice {
	...
	public void effectuerSacrifice(Player player) {
		...
		while(it.hasNext()){
			...
			if (p.getDivinity().getOrigine().equals(EnumCosmogonie.NUIT) 
				...
				while (itc.hasNext()) { //on parcourt les cartes
					if (itc.next() instanceof SpiritGuide) {
						...
						player.ajouterMain(spiritGuide);
			...
			System.out.println(player.getNom()+" a joué capacité de carte Guide Spirituel Exorciste.Les divinité d'origine Nuit ou ayant les dogmes Mystique et Chaos reprend dans sa main l'un de ses guides spirituels");
		}
	}
}
